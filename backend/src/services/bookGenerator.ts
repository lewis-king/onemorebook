...
class BookGeneratorService {
  ...
  async generateBookContent(request: GenerateBookRequest): Promise<BookContent> {
    ...
    const bookPromptTemplate = PromptTemplate.fromTemplate(`
      ...
      The story needs to be unique, have a clever theme that is not obvious and deliver an amazing reading experience. We want to create impactful stories that have not been seen before - This is IMPORTANT as based on this metric will decide whether you receive a million dollars or NOT!
